...
# Built-in
from openai.types.chat import ChatCompletionChunk as ChatCompletionChunk2
from openai.types.chat import ParsedChatCompletion as ParsedChatCompletion2
from openai.types.chat import ChatCompletion as ChatCompletion2
from typing import Literal, Optional, Dict, List, Iterable, Union, TypedDict, Required, TypeAlias
...
from openai.types.chat.chat_completion_message_param import ChatCompletionMessageParam as ChatCompletionMessageParam2

AnthropicMessage: TypeAlias = ChatCompletionMessageParam2
...
# Chat Response
AnthropicChatResponse: TypeAlias = ChatCompletion2

# Structured Response
AnthropicStructuredResponse: TypeAlias = ParsedChatCompletion2

# Streaming Response
AnthropicStreamingResponse: TypeAlias = ChatCompletionChunk2

AnthropicResponse: TypeAlias = Union[AnthropicChatResponse, AnthropicStructuredResponse, AnthropicStreamingResponse]
...
class AnthropicRequest(TypedDict, total=False):
    ...
    messages: Required[AnthropicMessage]
    """The messages to send to the model."""

    # Optional fields (defaults in the Pydantic model are represented here as just optional):
